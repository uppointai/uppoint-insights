  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={cn(
          'h-screen gradient-sidebar border-r border-sidebar-border flex flex-col z-50',
          'hidden lg:flex', // Desktop: always visible
          mobileOpen && 'fixed inset-y-0 left-0 flex lg:relative' // Mobile: overlay when open
        )}
      >
        {/* Mobile Close Button */}
        <Button
