          ...
          <DropdownMenuTrigger asChild>
            <Button variant="outline" className="gap-1 md:gap-2 px-2 md:px-4 min-h-[44px] text-xs md:text-sm">
              ...
              <span className="sm:hidden">
                {selectedRange === 'Letzte 24 Stunden' ? '24h' :
                 selectedRange === 'Letzte 7 Tage' ? '7T' :
                 selectedRange === 'Letzte 30 Tage' ? '30T' :
                 selectedRange === 'Letzte 90 Tage' ? '90T' : 'Jahr'}
              </span>
